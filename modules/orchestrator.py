...
# This allows the orchestrator module to reach the root 'config' folder
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

from config.settings import DATA_CACHE_DIR

# --- Keep your existing orchestrator code below this line ---
# Example:
...
class CoreOrchestrationEngine:
    ...
    def process_ticker_pipeline(self, ticker_symbol, asset_name, benchmark_df, sector_leaderboard):
        try:
            ...
            # Basic Fundamental & Sentiment checks (Fail-safe wrapped)
            ...
            print(f"❌ Error during orchestrator processing for {ticker_symbol}: {str(e)}")
            return None
